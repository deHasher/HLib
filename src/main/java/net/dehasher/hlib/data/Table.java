...
public enum Table implements MySQLTable {
	...
	LOG_MESSAGE_INDEX_DATETIME_ID_SERVER_ID("ALTER TABLE hcore_log_message ADD INDEX IF NOT EXISTS idx_hcore_log_message_datetime_id_server_id(datetime, id, server_id)"),
	LOG_MESSAGE_INDEX_SERVER_ID_DATETIME_ID("ALTER TABLE hcore_log_message ADD INDEX IF NOT EXISTS idx_hcore_log_message_server_id_datetime_id(server_id, datetime, id)"),
	...
	LOG_COMMAND_INDEX_DATETIME_ID_SERVER_ID("ALTER TABLE hcore_log_command ADD INDEX IF NOT EXISTS idx_hcore_log_command_datetime_id_server_id(datetime, id, server_id)"),
	LOG_COMMAND_INDEX_SERVER_ID_DATETIME_ID("ALTER TABLE hcore_log_command ADD INDEX IF NOT EXISTS idx_hcore_log_command_server_id_datetime_id(server_id, datetime, id)"),
